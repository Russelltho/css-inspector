...
{#if rect}
  <div
    ...
    style="transition: all 200ms ease-out; clip-path: polygon(0 0, 100% 0, 100% 100%, {rect.right}px 100%, {rect.right}px {rect.top}px, {rect.left}px {rect.top}px, {rect.left}px {rect.bottom}px, {rect.right}px {rect.bottom}px, {rect.right}px 100%, 0 100%)"
  />
{/if}
